...
import { setupBackgroundHandler } from "./src/push/handlers";
import { initAppCheck } from "./src/backend/firebase";
import { clearToken, getToken } from "./src/auth/token";
import { LoginScreen } from "./src/auth/LoginScreen";
import { registerDevice } from "./src/push/register";
import { deleteMe } from "./src/backend/reporter";
import {
  clearAppState,
  getRegistration,
  type Registration,
...
export default function App() {
  ...
  if (stage === "login") {
    return (
      <AppFrame>
        <LoginScreen onDone={() => setStage("consent")} />
      </AppFrame>
    );
  }
